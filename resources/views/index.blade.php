...
<head>
    ...
    <link rel="stylesheet" href="{{\Illuminate\Support\Facades\URL::asset('css/bootstrap.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{\Illuminate\Support\Facades\URL::asset('css/style.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{\Illuminate\Support\Facades\URL::asset('css/dark.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{\Illuminate\Support\Facades\URL::asset('css/font-icons.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{\Illuminate\Support\Facades\URL::asset('css/animate.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{\Illuminate\Support\Facades\URL::asset('css/magnific-popup.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{\Illuminate\Support\Facades\URL::asset('css/responsive.css')}}" type="text/css" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <!-- Document Title
    ============================================= -->
    <title>Hoang Lan - Ngoc Thao | Wedding</title>
...
<div id="wrapper" class="clearfix">
    ...
    <section id="slider" class="slider-element slider-parallax full-screen page-section dark clearfix">
            ...
            <div class="fslider" data-speed="2000" data-pause="6000" data-animation="fade" data-arrows="false" data-pagi="false" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; background-color: #333;">
                <div class="flexslider" style="height: 100% !important;">
                    <div class="slider-wrap" style="height: inherit;">
                        <div class="slide" style="background: url('{{\Illuminate\Support\Facades\URL::asset('images/wedding/2.jpg')}}') center center; background-size: cover; height: 100% !important;"></div>
                        <div class="slide" style="background: url('{{\Illuminate\Support\Facades\URL::asset('images/wedding/3.jpg')}}') center center; background-size: cover; height: 100% !important;"></div>
                        <div class="slide" style="background: url('{{\Illuminate\Support\Facades\URL::asset('images/wedding/1.jpg')}}') center center; background-size: cover; height: 100% !important;"></div>
                    </div>
                </div>
            </div>

            <div class="container-fluid vertical-middle dark center clearfix" style="z-index: 2;">


                <div class="divider divider-short divider-center"><i class="icon-heart3"></i></div>


                <div id="countdown-ex1" class="countdown countdown-large coming-soon divcenter" style="max-width:700px;padding-top: 250px"></div>
            ...
            <div class="container clearfix">
                ...
                <nav id="primary-menu" class="style-2 center">
                    ...
                    <ul class="one-page-menu">
                        ...
                        <li><a href="#" data-href="#section-events"><div>Events Schedule</div></a></li>
                        <li><a href="#" data-href="#section-locations"><div>Locations</div></a></li>
                        <li><a href="#" data-href="#section-rsvp"><div>RSVP</div></a></li>
                    </ul>
            ...
            <div class="container clearfix">
                ...
                <div class="row">
                    <div class="col-lg-6 bottommargin">
                        <div class="team team-list clearfix">
                            <div class="team-image" style="width: 150px;">
                                <img class="rounded-circle" src="{{\Illuminate\Support\Facades\URL::asset('images/wedding/4.jpg')}}" alt="Ding Hoang Lan">
                            </div>
                            <div class="team-desc">
                                <div class="team-title"><h4>Dinh Hoang Lan</h4><span>Groom</span></div>
                    ...
                    <div class="col-lg-6 bottommargin">
                        <div class="team team-list clearfix">
                            <div class="team-image" style="width: 150px;">
                                <img class="rounded-circle" src="{{\Illuminate\Support\Facades\URL::asset('images/wedding/5.jpg')}}" alt="Nguyen Thi Ngoc Thao">
                            </div>
                            <div class="team-desc">
                                <div class="team-title"><h4>Nguyen Thi Ngoc Thao</h4><span>Bride</span></div>
                ...
                <div class="container clearfix">
                    ...
                    <div class="form-widget">
                        ...
                        <form id="wedding-rsvp-form" action="include/form.php" method="post" class="bottommargin-lg divcenter" style="max-width: 500px;">
                            ...
                            <div class="col_full">
                                <input type="text" name="wedding-rsvp-name" id="wedding-rsvp-name" required="true" class="form-control required form-control-lg" placeholder="Your Full Name">
                            </div>

                            <div class="col_full">
                                <input type="text" name="wedding-rsvp-email" id="wedding-rsvp-email" required="true" class="form-control required email form-control-lg" placeholder="Your E-mail Address">
                            </div>

                            <div class="col_full">
                                <input type="number" min="1" max="10" name="wedding-rsvp-guests" id="wedding-rsvp-guests" class="form-control required form-control-lg" placeholder="No. of Guests">
                            </div>
                            ...
                            <input type="hidden" name="prefix" value="wedding-rsvp-">
                            <input type="hidden" name="subject" value="Wedding RSVP">
                            <input type="hidden" name="message[success]" value="RSVP Confirmation Received!">
...
<!-- Footer Scripts
============================================= -->
<script src="{{\Illuminate\Support\Facades\URL::asset('js/functions.js')}}"></script>
<script src="{{\Illuminate\Support\Facades\URL::asset('js/jquery.gmap.js')}}"></script>
<script src="https://maps.google.com/maps/api/js?key=AIzaSyCzkxzbEni5vR_Ugt1De8gBzrLX3236bnA"></script>
<script src=""></script>
<script>
    jQuery(document).ready( function($){
        var newDate = new Date(2020, 2, 14);
